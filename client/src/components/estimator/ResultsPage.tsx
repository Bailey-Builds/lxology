...
import { Question, Responses, ScoringResult } from '@/lib/tools/timeline/types';
import { PHASE_ALLOCATIONS } from '@/lib/tools/timeline/phases';
import { UNIVERSAL_QUESTIONS, getQuestionsForInitiative, isQuestionVisible } from '@/lib/tools/timeline/questions';
import { ADJUSTMENT_MULTIPLIERS } from '@/lib/tools/timeline/scoring';
